...
description: "A step-by-step guide to migrate your Resume Builder instance from v4 to v5, including manual and automated migration options."
---

## Overview

This guide walks you through migrating your Resume Builder installation from **v4 to v5**. The migration process involves setting up a new v5 instance alongside your existing v4 instance, then transferring your users and resumes to the new system.
...
<CardGroup cols={2}>
  <Card title="Running v4 Instance">Your existing Resume Builder v4 instance should be running and accessible.</Card>
  <Card title="New v5 Instance">
    A fresh Resume Builder v5 instance set up and running. Follow the [Self-Hosting with Docker](/self-hosting/docker)
...
<Step title="Import into v5">
  ...
  Select the **Resume Builder v4** format 4. Upload your exported JSON file The import process automatically converts
  the v4 format to v5.
</Step>
...
<CardGroup cols={1}>
  ...
  <Card title="Resume Builder Source Code">
    Clone the Resume Builder repository to access the migration scripts:
    ```bash
