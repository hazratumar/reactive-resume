---
title: "Quickstart"
description: "Get started with Resume Builder in minutes — use our hosted version or deploy your own instance"
---

## Options

Resume Builder offers flexibility in how you want to use it. Choose the option that best fits your needs:
...
The easiest way to use Resume Builder is through our cloud version at [resumebuilder.com](https://resumebuilder.com). **This service is completely free and will always remain free.**

<Steps>
	<Step title="Create an Account">
		Visit [resumebuilder.com](https://resumebuilder.com) and sign up for free using your email, or sign in with your GitHub or Google
		account.
	</Step>
...
For users who prefer complete control over their data, you can deploy Resume Builder on your own infrastructure using Docker.
...
<Steps>
	<Step title="Clone the Repository">
		```bash
		git clone https://github.com/amruthpillai/resume-builder.git
		cd resume-builder
		```
	</Step>
...
```
	...
	- **Redis** — Required for the AI Agent workspace
    	...
    	- **Resume Builder** — The main application
    </Step>

    <Step title="Access Your Instance">
    	Once all services are running, access your Resume Builder instance at:
...
| `reactive_resume` | 3000 | The main Resume Builder application                 |

<Note>
  Saved AI provider management requires `ENCRYPTION_SECRET`, and the AI Agent workspace requires both `REDIS_URL` and
  `ENCRYPTION_SECRET`. Other Resume Builder features can run without them. Agent attachments and other private objects
...
| `APP_URL`      | Public URL of your Application | `https://resumebuilder.com`                   |
...
<CardGroup cols={2}>
  <Card title="Development Setup" icon="code" href="/contributing/development">
    Set up a development environment to contribute or customize Resume Builder.
  </Card>
...
<Note>
  **Having trouble?** Check our [GitHub Issues](https://github.com/amruthpillai/resume-builder/issues) or reach out via
  [email](mailto:codesbyumar@gmail.com).
</Note>
