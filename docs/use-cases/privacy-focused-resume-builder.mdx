...
The source code is available on [GitHub](https://github.com/amruthpillai/resume-builder), so you can inspect how the application works. If you need direct control over infrastructure, storage, auth providers, and deployment policy, you can self-host Reactive Resume.
