...
description: "Understand the privacy-focused parts of Resume Builder, including open source transparency, self-hosting, public sharing controls, and optional AI provider configuration."
---

Resume Builder is a privacy-focused resume builder because it is open source, can be self-hosted, supports private-by-default resume editing, and makes sharing and optional AI features explicit choices.
...
The source code is available on [GitHub](https://github.com/amruthpillai/resume-builder), so you can inspect how the application works. If you need direct control over infrastructure, storage, auth providers, and deployment policy, you can self-host Resume Builder.
...
AI features are optional. Resume Builder does not need AI to create, edit, export, or share a resume. When you choose to use AI-assisted features, you configure a provider and key for the provider you want to use.
