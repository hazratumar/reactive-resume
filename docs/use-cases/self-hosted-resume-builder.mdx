...
description: "Run Resume Builder as a self-hosted resume builder with Docker, PostgreSQL, optional storage, SSO, and migration guidance."
---

Resume Builder can be run as a self-hosted resume builder when you want to operate the app on your own infrastructure instead of using the hosted instance.
...
- Resume Builder application container.
- PostgreSQL database.
...
<Tip>
  Replace hosted URLs such as <code>https://resumebuilder.com</code> with your own instance URL when following API, MCP, or
  sharing examples.
</Tip>
