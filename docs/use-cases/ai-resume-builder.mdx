...
description: "Use Resume Builder with optional BYO-provider AI assistance for resume analysis, builder edits, imports, and agent drafts."
---

Resume Builder can be used as an AI-assisted resume builder, but AI is optional and bring-your-own-provider: you configure the provider, model, endpoint, and API key you want Resume Builder to use.

## What AI does in Resume Builder
...
Resume Builder supports configuring an AI provider from the Integrations settings. The provider settings include the provider type, model, base URL when needed, and API key.
