...
Resume Builder includes two AI-assisted builder workflows:
...
<Steps>
  ...
  <Step title="Click Analyze Resume">
    Resume Builder sends the current resume data to your configured AI provider.
  </Step>
...
When the assistant proposes edits, Resume Builder shows a review card with:
