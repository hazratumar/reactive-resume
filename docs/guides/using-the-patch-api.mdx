...
<Info>
  If you're self-hosting, replace `https://resumebuilder.com` with your instance URL. The API is served under `/api/openapi`.
</Info>
...
```bash
curl -X PATCH "https://resumebuilder.com/api/openapi/resume/YOUR_RESUME_ID" \
