...
<Step title="Toggle 'Allow Public Access'">
  ...
  <Step title="Copy your public URL">
    ...
    ```
    https://resumebuilder.com/{username}/{slug}
    ```
...
2. **No account required** - Visitors don't need a Resume Builder account to view or download your resume
...
When your resume is public, Resume Builder tracks public views. This helps you understand whether people are opening the link you shared.
...
<Accordion title="Can I see who viewed my resume?">
  No, Resume Builder tracks public view counts, not the identity of visitors. This protects visitor privacy.
</Accordion>
