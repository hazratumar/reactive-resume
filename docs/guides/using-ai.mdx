...
description: "Learn how to configure an AI provider for AI-assisted features in Resume Builder."
---

Resume Builder uses AI providers for features such as resume analysis, AI-assisted resume changes, AI agent drafts, and PDF or Word imports.

## Open AI provider settings

<Steps>
  <Step title="Sign in to the dashboard">
    Head over to [https://resumebuilder.com](https://resumebuilder.com) and sign in with your account credentials.
  </Step>
...
| **API Key** | The key Resume Builder should use when sending AI requests to that provider. |
...
<Steps>
  <Step title="Click Test">
    Resume Builder sends a small request to verify the provider, model, base URL, and key.
  </Step>
  ...
  <Step title="Enable the provider">
    Turn on **Use** for the tested provider you want Resume Builder to use.
  </Step>
</Steps>
