...
When your resume content overflows the page, Resume Builder displays a warning just below the page. This guide explains how to reorganize and adjust your content so everything fits within your chosen page format.
...
<Warning>
  While Resume Builder supports multi-page resumes, each page has a fixed height based on your chosen format (A4 or
