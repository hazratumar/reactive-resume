...
description: "Learn how to create an account on Resume Builder and get started on building your resume"
---

<Steps>
  <Step title="Visit the homepage">
    Head over to [https://resumebuilder.com](https://resumebuilder.com) and click on the <Badge>Get Started</Badge> button.
  </Step>
  ...
  <Step title="Fill in your details">
    ...
    <Warning>
      Make sure to choose a username you're happy with, as it will be part of your public resume URL (e.g., `resumebuilder.com/your-username/resume-slug`).
    </Warning>

  </Step>
  
  <Step title="Sign up and log in">
    After filling in all the required fields, click the **Sign Up** button. You will be immediately logged in and can start using Resume Builder right away.
