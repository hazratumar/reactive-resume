...
Custom Styles do not accept raw CSS. Resume Builder renders final resumes through a PDF renderer, so Custom Styles use structured style rules that can be safely translated to PDF styles.
