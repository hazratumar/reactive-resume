...
If you self-host Resume Builder, the agent workspace also requires the server-side agent configuration described in [Self-hosting with Docker](/self-hosting/docker).
