...
Below is the complete JSON Schema for Reactive Resume. You can also fetch the latest version directly from [https://resumebuilder.com/schema.json](https://resumebuilder.com/schema.json).
