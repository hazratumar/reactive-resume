...
description: "Set up a local development environment for Resume Builder"
---
...
This guide walks you through setting up Resume Builder for local development. Whether you're contributing to the project or customizing it for your needs, these steps will get you up and running.
...
<Steps>
  ...
  <Step title="Start the Development Server">
    ...
    Your local Resume Builder instance will be available at [http://localhost:3000](http://localhost:3000).
  </Step>
</Steps>
...
Resume Builder uses [Lingui](https://lingui.dev/) for internationalization.
...
// For JSX content
<Trans>Welcome to Resume Builder</Trans>;
```
