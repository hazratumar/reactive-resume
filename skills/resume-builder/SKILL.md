---
name: resume-builder
description: Generate professional resumes that conform to the Resume Builder schema. Use when the user wants to create, build, or generate a resume through conversational AI, or asks about resume structure, sections, or content. This skill guides the agent to ask clarifying questions, avoid hallucination, and produce valid JSON output for https://resumebuilder.com.
---

# Resume Builder for Resume Builder

Build professional resumes through conversational AI for [Resume Builder](https://resumebuilder.com), a free and open-source resume builder.
...
Output must conform to the Resume Builder schema. See [references/schema.md](references/schema.md) for the complete schema structure.
...
When generating the resume, output a complete JSON object that conforms to the Resume Builder schema. The user can then import this JSON directly into Resume Builder at https://resumebuilder.com.
