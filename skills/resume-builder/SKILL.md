...
Build professional resumes through conversational AI for [Reactive Resume](https://resumebuilder.com), a free and open-source resume builder.
...
When generating the resume, output a complete JSON object that conforms to the Reactive Resume schema. The user can then import this JSON directly into Reactive Resume at https://resumebuilder.com.
