...
const getFaqItems = (): FAQItemData[] => [
	...
	},
	{
		...
		answer: t`Your data is stored securely and is never shared with third parties. You can also self-host Resume Builder on your own servers for complete control over your data.`,
	},
	{
	...
	{
		question: t`Is Resume Builder available in multiple languages?`,
		answer: (
			<Trans>
				Yes, Resume Builder is available in multiple languages. You can choose your preferred language in the settings
